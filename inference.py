...
def infer():
    ...
    parser.add_argument('--model_name_or_path', default="instruct_logging/codellama7b_task1-5_6epoch/checkpoint-5555", type=str)
    parser.add_argument('--in_file', default="task_data/task5_test.tsv", type=str)
    parser.add_argument('--out_file', default="result_file/predictions5_5epoch.tsv", type=str)
